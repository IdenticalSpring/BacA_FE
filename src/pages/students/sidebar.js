...
const Sidebar = ({
  ...
  useEffect(() => {
    if (!selectedLessonBySchedule && filteredLessons.length > 0) {
      // Removed default selection of latest lesson
    }
  }, [lessonsBySchedule, selectedLessonBySchedule, onSelectLessonBySchedule, filteredLessons]);
                ...
                >
                  ...
                  <Text
                    style={{
                      ...
                      textOverflow: "ellipsis",
                      whiteSpace: "nowrap", // Keep nowrap for ellipsis on both mobile and non-mobile
                      overflow: "hidden",
                      maxWidth: isMobile ? "150px" : "130px", // Slightly larger maxWidth on mobile to match original
                    }}
                  >
                    {lessonNames[item.lessonID] || "Đang tải..."}
                  </Text>
